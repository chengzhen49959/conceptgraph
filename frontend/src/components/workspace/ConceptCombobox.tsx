...
/**
 * Searchable concept picker. Replaces a plain <select> for choosing a relation
 * target: type to filter, or browse a list sorted by pinyin with sticky section
 * headers. Reusable for any "pick a concept" spot.
 */
